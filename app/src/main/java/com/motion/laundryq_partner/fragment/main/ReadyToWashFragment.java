 ...
 */
public class ReadyToWashFragment extends Fragment implements CucianAdapter.OnButtonDetailClicked {
    @BindView(R.id.swipe)
    ...
    public void onButtonClick(OrderModel orderModel) {
        ...
        intent.putExtra(KEY_DATA_INTENT_READY_TO_SEND, false);
