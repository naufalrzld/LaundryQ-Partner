 ...
 */
public class ReadyToSendFragment extends Fragment implements CucianAdapter.OnButtonDetailClicked {
    @BindView(R.id.swipe)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String laundryID_status = laundryModel.getLaundryID() + "_4";
    ...
    public void onButtonClick(OrderModel orderModel) {
        ...
        intent.putExtra(KEY_DATA_INTENT_READY_TO_SEND, true);
